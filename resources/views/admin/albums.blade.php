...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('admin.albums.create') }}" class="btn btn-sm btn-primary shadow-sm">
            <i class="fas fa-plus fa-sm text-white-50"></i> Add New Album
        </a>
    </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <th>Album Title</th>
                        <th>Artist</th>
                        <th>Genre/Info</th> <th>Actions</th>
                    </tr>
                    </thead>
                    <tbody>
                        ...
                        @foreach($albums as $album)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.albums.details', $album->id) }}" class="btn btn-primary btn-sm">Details</a>
                                    <a href="{{ route('admin.albums.delete', $album->id) }}"
                                       class="btn btn-danger btn-sm"
                                       onclick="return confirm('Are you sure thet you want to delete this album?')">
                    ...
                    @else
                        <tr>
                            <td colspan="5" class="text-center text-muted py-4">
                                <i class="fas fa-info-circle mr-1"></i> No album data found yet.
                            </td>
                        </tr>
                    @endif
                    </tbody>
